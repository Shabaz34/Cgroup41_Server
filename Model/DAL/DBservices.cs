...
namespace UniServer.Models.DAL
{
    ...
    public class DBservices
    {
        ...
        public List<User> LogIn(string password, string email)
        {
            ...
            try
            {
                ...
                while (dataReader.Read())
                {
                    ...
                    user.UserPassword = "";
                    user.UserToken= dataReader["userToken"].ToString();
                    listUser.Add(user);
                }
        ...
        private SqlCommand CreateCommandWithSPInsertPhoto(String spName, SqlConnection con, Photo pic)
        {
            ...
            // cmd.Parameters.AddWithValue("@identificationId", pic.IdentificationId.HasValue ? pic.IdentificationId : DBNull.Value);
